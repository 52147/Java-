...
- capped: true
- mean the collection size is fixed. If the size is larger than the max size, new data will cover the old data. 
```
db1> db.item.stats()
{
  ns: 'db1.item',
  ...
  wiredTiger: {
    ...
    type: 'file',
    uri: 'statistics:table:collection-7--4088369856889030971',
    LSM: {
    ...
    btree: {
      'btree checkpoint generation': 2868,
