...
3. npm install moduleName --save
   ...
   - 運行npm install--production 時，會自動下載模塊到node_modules 目錄下
4. npm install moduleName --save-dev
   - 安裝模塊到node_modules 目錄下
   - 不會將模塊依賴寫入devDependencies 節點
   - 運行npm install 初始化項目時，會安裝模塊到項目目錄下
   - 運行npm install--production 時，不會自動下載模塊到node_modules 目錄下

https://juejin.cn/post/6984233647574351885      
https://cloud.tencent.com/developer/article/1537820     
